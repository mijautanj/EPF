...
class LSTM_class():
    ...
    def lstm_data(self):
        ...
        X_train, y_train = extractValues(dataDict["train"][0],dataDict["train"][1],TARGETNAME)
        X_val, y_val = extractValues(dataDict["val"][0],dataDict["val"][1],TARGETNAME)
